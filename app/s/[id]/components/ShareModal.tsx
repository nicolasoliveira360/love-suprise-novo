...
interface ShareModalProps {
  isOpen: boolean;
  onClose: () => void;
  onShare: (platform: 'whatsapp' | 'facebook' | 'instagram') => void;
}
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-navy-800 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-4 rounded-lg bg-navy-900 hover:bg-navy-700 transition-colors"
                  >
